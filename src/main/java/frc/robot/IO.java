...
public class IO {
  ...
  protected static final ThresholdTrigger xbox_LT = new ThresholdTrigger(() -> m_xbox.getLeftTriggerAxis(), 0.9);
  protected static final ThresholdTrigger xbox_RT = new ThresholdTrigger(() -> m_xbox.getRightTriggerAxis(), 0.9);
  ...
  {
    return m_xbox.getLeftY() * -1; // * -1 because up is -1 on the joystick
  }
  ...
  protected static double getXBoxRightY() {
    return m_xbox.getRightY() * -1; // * -1 because up is -1 on the joystick
  }
  
  protected static double getXBoxLeftTrigger()  {
    return m_xbox.getLeftTriggerAxis();
  }
  
  protected static double getXBoxRightTrigger() {
    return m_xbox.getRightTriggerAxis();
  }
