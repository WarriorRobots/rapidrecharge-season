...
public class Vars {
  ...
  // turret
  public static final double TURRET_MAX_ROTATION = 210; // degrees clockwise, clockwise bound // TODO ask josh about
                                                        // this value
  ...
  public static final double TURRET_RAMP_UP_TIME = 0.0; // Seconds
  ...
  public static final int SHOOTER_FRONT_NATIVE_ESTIMATED_VELOCITY = (int) (SHOOTER_FRONT_ESTIMATED_RPM
      / SHOOTER_FRONT_GEARING / 600 * Constants.CLICKS_PER_REV_INTEGRATED);
  public static final int SHOOTER_BACK_NATIVE_ESTIMATED_VELOCITY = (int) (SHOOTER_BACK_ESTIMATED_RPM / 600
      * Constants.CLICKS_PER_REV_QUADRATURE);
   ...
   * Use this to convert from 1 rotation of the motor to 1 rotation of the output
   * shaft: input * GEARING = output.
   */
  // Drivetrain
  /**
  ...
  // public static final double CLIMB_NATIVE_PER100MS =
  // ClimbSubsystem.toClicks(CLIMB_SPEED*0.1); //Native units/100 ms
  // public static final double CLIMB_NATIVE_PER_100MS_PER_SEC =
  // ClimbSubsystem.toClicks(CLIMB_ACCELERATION*0.1); //(Native units/100 ms)/sec
  ...
  public static final double CLIMB_OUT_AND_UP = 40000; // native (used when the pistons are put out so the climb does
                                                       // not get stuck) TODO change later
  ...
  public static final Pose2d AUTOBALLA3 = new Pose2d(Units.inchesToMeters(-108.02), Units.inchesToMeters(-88.27), Rotation2d.fromDegrees(206.5));
