...
public class Vars {
  ...
  public static final double SHOOTER_FRONT_CLICKS_PER_REV = 2048.0; //TODO check
  /** output rotations per input rotations */
  public static final double SHOOTER_FRONT_GEARING = 4.0/5.0; 
  public static final double SHOOTER_DEFAULT = 3500; //rpm
  ...
  /** Backspin Shooter KP */
  public static final double BACKSPIN_KP = 0.0015;
  ...
  /**Front shoote estimated RPM */
    public static final double ESTIMATED_RPM_FRONTSHOOTER = 3580;
  /**Back SHooter  Estimated RPM */
    public static final double ESTIMATED_RPM_BACKSPIN = 3420;

  /** Typical motor output as percent */
  public static final double SHOOTER_FRONT_ESTIMATED_VOLTAGE =  0.88; // TODO move this to Vars
  /** Velocity of shooter in native units per 100ms at typical motor output (at the encoder) */
  public static final int SHOOTER_FRONT_NATIVE_ESTIMATED_VELOCITY = (int)(ESTIMATED_RPM_FRONTSHOOTER / 600 * SHOOTER_FRONT_CLICKS_PER_REV);
  
  /** Typical motor output as percent */
  public static final double SHOOTER_BACK_ESTIMATED_VOLTAGE = 0.40; // TODO move this to Vars
  /** Velocity of shooter in native units per 100ms at typical motor output (at the encoder) */
  public static final int SHOOTER_BACK_NATIVE_ESTIMATED_VELOCITY = (int)(ESTIMATED_RPM_BACKSPIN / 600 * SHOOTER_BACK_CLICKS_PER_REV); // TODO move this to Vars
