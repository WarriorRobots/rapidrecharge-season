...
public class AutoShootBackIntake extends SequentialCommandGroup {
  /** Creates a new AutoBackIntake. */
  public AutoShootBackIntake(DrivetrainSubsystem drive, ShooterSubsystem Shooter, TurretSubsystem Turret,
