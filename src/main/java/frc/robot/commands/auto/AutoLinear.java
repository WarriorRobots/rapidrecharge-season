...
private ProfiledPIDController profileController;
  ...
  public AutoLinear(DrivetrainSubsystem drive, double set_point) {
    ...
    profileController = new ProfiledPIDController(Vars.AUTO_LINEAR_P, Vars.AUTO_LINEAR_I, Vars.AUTO_LINEAR_D, new TrapezoidProfile.Constraints(Vars.MAX_VELOCITY, Vars.MAX_ACCELERATION));
  ...
  public void initialize() {
    double averageSpeed = Units.metersToInches(m_drive.getWheelSpeeds().leftMetersPerSecond+ m_drive.getWheelSpeeds().rightMetersPerSecond)/ 2;
