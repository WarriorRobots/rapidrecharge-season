...
public class AutoShootBack extends SequentialCommandGroup {
  /** Creates a new ShootBack. */
  public AutoShootBack(DrivetrainSubsystem drive, ShooterSubsystem Shooter, TurretSubsystem Turret,
